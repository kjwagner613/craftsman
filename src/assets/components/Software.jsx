        ...
        <ol>
          ...
          <li>
            <div className="body-container" style={{ maxWidth: "var(--max-width)" }}>
              ...
              <p className="project-link"><a className="Link-wrapper" href="https://wagner-cookbook-944b51777ea1.herokuapp.com/" target="_blank"
                rel="noopener noreferrer">Live App on Heroku </a> | <a
