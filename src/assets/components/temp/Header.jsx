...
import { scrollToTop } from '..utils/scrollUtils'; // Assuming you have a utility function for scrolling
import { commonStyles, cssVars, combineClasses } from '../utils/commonStyles'; // Assuming you have a utility for combining classes and styles
...
const Header = ({ selected }) => {
  ...
  return (
    <div className={combineClasses("min-h-screen", commonStyles.centerFlex, commonStyles.fullWidth)} style={cssVars.maxWidth}>
      <div className={combineClasses(
        commonStyles.fullWidth,
        "text-center",
        commonStyles.fadeIn,
        isVisible ? commonStyles.visible : commonStyles.hidden
      )}>
        <div className={combineClasses("mt-2", commonStyles.textContainer)} style={cssVars.maxWidth}>
